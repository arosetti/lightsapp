...
public class LinearFilterD {
    private final static String TAG = LinearFilterD.class.getSimpleName();
    ...
    public static final LinearFilterD[] Kernel = {
            new LinearFilterD(Filter.KERNEL_NONE,
                    new double[]{1f}),
            new LinearFilterD(Filter.KERNEL_GAUSSIAN_5,
                    new double[]{0.535139208712f,
                            0.191553166229f,
                            0.0358772294153f}),
            new LinearFilterD(Filter.KERNEL_GAUSSIAN_11,
                    new double[]{0.197952965559f,
                            0.173313792797f,
                            0.118141540812f,
                            0.0645048567988f,
                            0.0290276086587f,
                            0.0110357181537f}),
            new LinearFilterD(Filter.KERNEL_SAVITZKY_GOLAY_5,
                    new double[]{17f, 12f, -3f}),
            new LinearFilterD(Filter.KERNEL_SAVITZKY_GOLAY_11,
                    new double[]{89f, 84f, 69f, 44f, 9f, -36f}),
    };
    ...
    public static LinearFilterD get(Filter id) {
    ...
    private LinearFilterD(Filter kernel, final double[] weight) {
        this.kernel = kernel;
     ...
     *
     * @param x the array of doubles to operate on. Will be mutated.
     */
    public void apply(double[] x) {
        if (kernel == Filter.KERNEL_NONE)
            return;
        final int N = x.length;
        double[] raw_x = x.clone();
        int i;
        double sum, norm;
